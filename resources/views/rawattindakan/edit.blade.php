...
<div class="container">
    <br>
    <form class="form-group" action="/rawattindakan/{{$data->no_tindakan}}" method="post">
        {{csrf_field()}}
        {{method_field('PUT')}}
<br>
<br>
        <div class="row atur-ukuran">
            ...
            <input type="date" name="tgl_tindakan" value="{{$data->tgl_tindakan}}" class="form-control" required>
        </div>
<br>
        <div class="row atur-ukuran">
