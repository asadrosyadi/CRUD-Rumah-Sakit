...
<div class="container">
    <br>
    <form class="form-group" action="/rawatpasien/{{$data->no_rawat}}" method="post">
        {{csrf_field()}}
        {{method_field('PUT')}}
<br>
<br>
        <div class="row atur-ukuran">
            ...
            <input type="date" name="tgl_rawat" value="{{$data->tgl_rawat}}" class="form-control" required>
        </div>
<br>
        <div class="row atur-ukuran">
...
<br>
        <div class="row atur-ukuran">
            ...
            <input type="text" name="hasil_diagnosa" value="{{$data->hasil_diagnosa}}" class="form-control">
        </div>
<br>
        <div class="row atur-ukuran">
