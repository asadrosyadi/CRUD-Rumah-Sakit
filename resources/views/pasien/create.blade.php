...
<div class="container">
    <br>
    <form class="form-group" action="/pasien" method="post">
        {{csrf_field()}}

        <div class="row atur-ukuran">
            <label for="nm_pasien">Nama Pasien</label>
            <input type="text" name="nm_pasien" value="" class="form-control" required>
        </div>
<br>
        <div class="row atur-ukuran">
            <label for="nm_pasien">No Identitas</label>
            <input type="number" name="no_identitas" value="" class="form-control" required>
        </div>
<br>
        <div class="row atur-ukuran">
